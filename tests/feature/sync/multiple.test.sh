...
it_creates_two_files_add_them_commit_them_and_push_them()
{
    ...
    [[ $( ls -A "$LOCAL/.git/modified" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.002.foo.001|.file.002.foo.002)$" ) -eq $( ls -A "$LOCAL/.git/modified" | wc -l ) ]]
    ...
    [[ $( ls -A "$LOCAL/.git/committed" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.001.foo.003|file.001.foo|.file.002.foo.001|.file.002.foo.002|.file.002.foo.003|file.002.foo)$" ) -eq $( ls -A "$LOCAL/.git/committed" | wc -l ) ]]
    assert "files - Committed files should be present"
    [[ $( ls -A "$REMOTE" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.002.foo.001|.file.002.foo.002)$" ) -eq $( ls -A "$REMOTE" | wc -l ) ]]
...
it_creates_a_file_adds_it_commits_it_creates_another_file_adds_it_commits_it_and_push_them()
{
    ...
    assert "files - Modified files should be present"
    [[ $( ls -A "$LOCAL/.git/staged" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.001.foo.003|.file.001.foo.004|.file.001.foo.005|.file.002.foo.001|.file.002.foo.002|.file.002.foo.003)$" ) -eq $( ls -A "$LOCAL/.git/staged" | wc -l ) ]]
    assert "files - Staged files should be present"
    [[ $( ls -A "$LOCAL/.git/committed" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.001.foo.003|.file.001.foo.004|.file.001.foo.005|.file.002.foo.001|.file.002.foo.002|.file.002.foo.003|file.001.foo|file.002.foo)$" ) -eq $( ls -A "$LOCAL/.git/committed" | wc -l ) ]]
    assert "files - Committed files should be present"
    [[ $( ls -A "$REMOTE" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.001.foo.003|.file.001.foo.004|.file.002.foo.001|.file.002.foo.002)$" ) -eq $( ls -A "$REMOTE" | wc -l ) ]]
    assert "files - Pushed files should be present"
...
it_creates_a_file_adds_it_commits_it_pushes_it_creates_another_file_adds_it_commits_it_and_pushes_it()
{
    ...
    [[ $( ls -A "$LOCAL/.git/staged" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.001.foo.003|.file.001.foo.004|.file.001.foo.005|.file.002.foo.001|.file.002.foo.002|.file.002.foo.003)$" ) -eq $( ls -A "$LOCAL/.git/staged" | wc -l ) ]]
    assert "files - Staged files should be present"
    [[ $( ls -A "$LOCAL/.git/committed" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.001.foo.003|.file.001.foo.004|.file.001.foo.005|.file.001.foo.006|.file.002.foo.001|.file.002.foo.002|.file.002.foo.003|file.001.foo|file.002.foo)$" ) -eq $( ls -A "$LOCAL/.git/committed" | wc -l ) ]]
    assert "files - Committed files should be present"
    [[ $( ls -A "$REMOTE" | grep -Ec "^(.file.001.foo.001|.file.001.foo.002|.file.001.foo.003|.file.001.foo.004|.file.001.foo.005|.file.002.foo.001|.file.002.foo.002)$" ) -eq $( ls -A "$REMOTE" | wc -l ) ]]
    assert "files - Pushed files should be present"
