...
then
    ...
    then
        ...
        then
            ...
            printf "\033[1;36m[ Flint ] Hooks directory 'hooks' already exists in \"/.flint\" directory. Skipping.\033[0m\n"
        fi
    ...
    printf "\n\033[1;36m[ Flint ] \"/.flint\" directory already exists in project root. Skipping.\033[0m\n"
fi
